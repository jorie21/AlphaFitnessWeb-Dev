...
export const featureSelection = [
  {
    ...
    description:
      "Relax your muscles and mind with our modern sauna for post-training wellness",
  ...
  },
  {
    title: "5000+ Members",
    description:
      "Join our thriving community of fitness enthusiasts and achievers",
  ...
  },
  {
    ...
    description:
      "State-of-the-art machines and free weights from top manufacturers",
...
export const vipFeature = [
  "Personal Locker",
  "Free Keycard",
  "Discounts for Sauna and Group Class",
  "Free Guest Pass(2session)",
  "All Access (M.M.A Area)"
];
...
export const testimonials = [
  {
    ...
    rating: 5,
    testimonial:
      "Alpha Fitness transformed my life! The trainers are incredibly supportive, and the community is amazing. I've never felt better.",
  ...
  },
  {
    ...
    rating: 4,
    testimonial:
      "The facilities are top-notch, and the variety of classes keeps me motivated. Highly recommend for anyone serious about their fitness journey.",
    image: "/icons/coach.png",
    name: "John Smith",
    role: "Gym Member",
  },
  {
    ...
    rating: 5,
    testimonial:
      "I've seen incredible results since joining Alpha Fitness. The personalized training plans made all the difference.",
    image: "/icons/coach.png",
    name: "Emily White",
    role: "Athlete",
  },
  {
    ...
    rating: 5,
    testimonial:
      "The atmosphere is so positive and encouraging. It's more than just a gym; it's a family.",
    image: "/icons/coach.png",
    name: "Michael Brown",
    role: "New Member",
  },
  {
    ...
    rating: 4,
    testimonial:
      "Great equipment and clean environment. The staff is always friendly and helpful.",
    image: "/icons/coach.png",
    name: "Sarah Green",
  ...
  },
  {
    ...
    rating: 5,
    testimonial:
      "Joining Alpha Fitness was the best decision for my health. The classes are challenging and fun!",
    image: "/icons/coach.png",
    name: "David Lee",
