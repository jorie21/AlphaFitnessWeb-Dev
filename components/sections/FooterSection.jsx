      ...
      <div className="screen flex w-full h-full py-16 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            {/* Company Info - Full width on mobile, spans 2 cols on medium screens */}
            <div className="md:col-span-2 lg:col-span-1 space-y-6">
              ...
              {/* Social media or additional info could go here */}
              <div className="flex space-x-3 pt-4">
                <div className="w-10 h-10 bg-secondary/20 rounded-full flex items-center justify-center hover:bg-secondary/40 transition-all duration-300 cursor-pointer group">
                  <Facebook className="w-4 h-4 text-secondary group-hover:scale-110 transition-transform duration-300" />
                </div>
                <div className="w-10 h-10 bg-secondary/20 rounded-full flex items-center justify-center hover:bg-secondary/40 transition-all duration-300 cursor-pointer group">
                  <Instagram className="w-4 h-4 text-secondary group-hover:scale-110 transition-transform duration-300" />
                </div>
                <div className="w-10 h-10 bg-secondary/20 rounded-full flex items-center justify-center hover:bg-secondary/40 transition-all duration-300 cursor-pointer group">
                  <Twitter className="w-4 h-4 text-secondary group-hover:scale-110 transition-transform duration-300" />
                </div>
              </div>
            </div>
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    <div className="flex-shrink-0 mt-0.5">
                      <info.icon className="w-5 h-5 text-secondary group-hover:scale-110 transition-transform duration-300" />
                    </div>
